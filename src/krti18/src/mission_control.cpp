...
int main (int argc, char **argv){
	...
	ROS_INFO("mission_control is starting!");
	...
	ROS_INFO("mission_control is shutting down!");
...
/*
[X] 1. USLEEP SEBELUM count_validate DI-RESET : BUTUH BERAPA DETIK?
[X] 2. HATI-HATI BAROMETER BALA, KARENA KITA ADA MODE AUTO YANG BERGANTUNG PADA BAROMETER (BUKAN LIDAR)
[X] 3. KALIBRASI HSV MOMOGI ==> BIKIN KERANGKA
	4. KALIBRASI NILAI validation_thresh
[X] 5. KALO MOOMOGI GAK KEDETECT, GEJALANYA SI COPTER LOITER KELAMAAN, RETRY!
...
[X] 6. CEK APAKAH fm_changer BISA BALIK KE MODE STABILIZE? KALO SUDAH STABILIZE LAGI,
	   APAKAH PERGANTIAN MODE TETAP NORMAL TANPA HARUS MEMATIKAN ROS ATAU PERLU MATIKAN ROS? ==> COBA SEKARANG ==> [DONE, PERLU MEMAINKAN ROS TERNYATA]
[X] 7. UNTUK MISSION DROP, PIKIRIN MEKANISME TRIGGER EPM. (EPM SELALU NYALA, PADA SAAT MISI DROP
       UBAH OFF -> DELAY BENTAR -> ON IN LAGI)
	8. CEK ORIENTASI KAMERA DAN VX_VY RELATIF PIXHAWK. PLOTTING!
	9. CEK RUMUS PID. CEK NILAI ERROR.
[X] 10.BUAT ARDUINO. [MAHDI UDAH BUAT, DI /home/odroid/Desktop/lidar_test DAN rosserial COPAS DARI YANG KK NADHIF]
[X] 11.CARA INCLUDE MAVROS APM.LAUNCH DI LAUNCH FILE KITA? [GAK BISA DIINCLUDE, NANTI RUN DI 2 TERMINAL]
	12.BUAT NODE UNTUK MASING-MASING GERAKAN
	13.CARI HSV VALUE UNTUK MOMOGI
	14.CARI HEIGHT_UP, DOWN, DROP, MP
*/
